...
//WebElement alertts = driver.findElement(By.xpath("//button[@class='btn btn-danger']"));
//alertts.click();

WebElement alertok = driver.findElement(By.xpath("(//a[@class='analystic'])[3]"));
alertok.click();

WebElement al = driver.findElement(By.xpath("//button[@class='btn btn-info']"));
al.click();
...
Select s = new Select(al);
List<WebElement> options = s.getOptions();
int size = options.size();

Alert a = driver.switchTo().alert();
a.sendKeys("automatic");
a.accept();
